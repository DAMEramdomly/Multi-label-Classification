...
class ShuntedTransformer(nn.Module):
    def __init__(self, img_size=[256, 512], patch_size=16, in_chans=3, num_classes=4, embed_dims=[64, 128, 256, 512],
        ...
        for i in range(num_stages):
            if i ==0:
                ...
                patch_embed = OverlapPatchEmbed(img_size=[img_size[0] // (2 ** (i + 1)), img_size[1] // (2 ** (i + 1))],
                                                patch_size=3, stride=2, in_chans=embed_dims[i - 1],

...
class Transformer(nn.Module):
    ...
    def forward(self, x):
        ...
        return x
class ViT(nn.Module):
    def __init__(self, *, image_size=(256, 512), patch_size=32, num_classes=4, dim=1024, depth=6, heads=16, mlp_dim=2048, pool='cls', channels=3, dim_head=64, dropout=0.1, emb_dropout=0.1):
        super().__init__()
